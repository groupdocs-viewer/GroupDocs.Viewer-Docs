...
---
[GroupDocs.Viewer for Python via .NET](https://products.groupdocs.com/viewer/python-net) allows you to render your email messages in HTML, PDF, PNG, and JPEG formats. You do not need to use third-party email clients to view the contents of email files within your Python application (web or desktop). 
...
# ...
    ...
    with gv.Viewer(test_files.sample_eml) as viewer:
        ...
        viewOptions.email_options.page_size = gvo.PageSize.Letter
        viewer.view(viewOptions)
```
{{< /tab >}}
{{< /tabs >}}
...
#  ...
    ...
    with gv.Viewer(test_files.sample_eml) as viewer:
        ...
        html_options.email_options.field_text_map[gvo.Field.FROM] = "Sender"
        html_options.email_options.field_text_map[gvo.Field.TO] = "Receiver"
        html_options.email_options.field_text_map[gvo.Field.SENT] = "Date"
        html_options.email_options.field_text_map[gvo.Field.SUBJECT] = "Topic"
        viewer.view(html_options)
```
{{< /tab >}}
{{< /tabs >}}
...
<!-- TODO ### Specify the date and time format and change the time zone -->
