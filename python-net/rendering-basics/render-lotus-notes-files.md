...
---
[GroupDocs.Viewer for Python via .NET](https://products.groupdocs.com/viewer/python-net) allows you to render [Lotus Notes Storage Facility (NSF)](https://docs.fileformat.com/database/nsf/) files in HTML, PDF, PNG, and JPEG formats. Use this library to display the contents of NSF files within your Python application (web or desktop). 
...
# ...
    ...
    with gv.Viewer(test_files.sample_nsf) as viewer:
        ...
        html_options.mail_storage_options.max_items = 20;
        viewer.view(html_options)
```
{{< /tab >}}
{{< /tabs >}}
...
# ...
    ...
    with gv.Viewer(test_files.sample_nsf) as viewer:
        html_options = gvo.HtmlViewOptions.for_embedded_resources()
        # Set filters.
        html_options.mail_storage_options.text_filter = "Viewer";
        html_options.mail_storage_options.address_filter = "groupdocs@mail.com";
        viewer.view(html_options)
```
{{< /tab >}}
{{< /tabs >}}
