...
| [DGN](https://docs.fileformat.com/cad/dgn) | MicroStation Design File (V7) | ![(tick)](/viewer/java/images/check-blue.png) | DGN V8 is not supported <br> as DGN V8 file format <br> is proprietary. |
| [DWF](https://docs.fileformat.com/cad/dwf/) | Design Web Format | ![(tick)](/viewer/java/images/check-blue.png) | |
| [DWG](https://docs.fileformat.com/cad/dwg/) | AutoCAD Drawing | ![(tick)](/viewer/java/images/check-blue.png) | Supported formats: <br> Release 11, 12, 13, 14. <br> DWG 2000, 2000i, 2002. <br> DWG 2004, 2005, 2006. <br> DWG 2010, 2011, 2012. <br> DWG 2013, 2014, 2015, 2016. |
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view CAD files: [Render CAD drawings and models as HTML, PDF, and image files](/viewer/java/render-cad-drawings-and-models).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view NSF files: [Render Lotus Notes database files as HTML, PDF, and image files](/viewer/java/render-lotus-notes-database-files/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view email messages: [Render email messages as HTML, PDF, PNG, and JPEG files](/viewer/java/render-email-messages/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view image files: [Render images as HTML, PDF, PNG, and JPEG files](/viewer/java/render-images/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view Microsoft Outlook data files: [Render Outlook data files as HTML, PDF, and image files](/viewer/java/render-outlook-data-files/).
...
| [OFD](https://www.zhihuilib.com/en/article/detail/2/12) | Open Fixed-layout Document |  | GroupDocs.Viewer requires that font [SimSun.ttf](https://learn.microsoft.com/en-us/typography/font-list/simsun) must be installed on the operating system to process this file type. Learn more [here](/viewer/java/render-pdf-documents#render-ofd-documents). |

Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view PDF files: [Render PDF documents as HTML and image files](/viewer/java/render-pdf-documents/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view presentations: [Render PowerPoint presentations as HTML, PDF, and image files](/viewer/java/render-presentations/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view Project files: [Render Microsoft Project documents as HTML, PDF, and image files](/viewer/java/render-ms-project-files/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view spreadsheet files: [Render Excel and Apple Numbers spreadsheets as HTML, PDF, and image files](/viewer/java/render-excel-and-apple-numbers-spreadsheets/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view text and code files: [Render text documents as HTML, PDF, and image files](/viewer/java/render-text-files/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view Microsoft Visio files: [Render Visio documents as HTML, PDF, and image files](/viewer/java/render-visio-documents/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view web files: [Render web documents as PDF, PNG, and JPEG files](/viewer/java/render-web-documents/).
...
Refer to the following help topic for details on how to use GroupDocs.Viewer to load and view Word documents: [Render Word documents as HTML, PDF, and image files](/viewer/java/render-word-documents/).
