...
In case you need to view an SVG(SVGZ) file in a browser or in a standard image or PDF viewer application, you can convert it to HTML, JPEG, PNG PDF format with [GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java).
...
To convert SVG/SVGZ files to HTML with [GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java) use following code:
...
To convert SVG/SVGZ files to JPG with [GroupDocs.Viewer](https://products.groupdocs.com/viewer) for Java use following code:
...
To convert SVGZ files to PDF with [GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java) use following code:
