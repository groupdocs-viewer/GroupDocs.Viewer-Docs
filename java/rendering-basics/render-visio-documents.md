...
url: viewer/java/render-visio-documents
title: Render Visio documents as HTML, PDF, and image files
linkTitle: Render Visio documents
weight: 5
description: "This topic describes how to use the GroupDocs.Viewer Java API to convert Visio diagrams to HTML, PDF, PNG, and JPEG formats."
...
toc: True
aliases:
    - viewer/java/view-visio-documents
    - viewer/java/how-to-render-visio-files-figures
---
[GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java) allows you to render your Visio diagrams in HTML, PDF, PNG, and JPEG formats. You do not need to use Microsoft Visio or other diagramming software to load and view Visio files within your Java application (web or desktop). 
...
{{< button style="primary" link="https://products.groupdocs.app/viewer/visio" >}} {{< icon "gdoc_person" >}} View Visio files online {{< /button >}} {{< button style="primary" link="https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java" >}} {{< icon "gdoc_github" >}} View demos and examples on GitHub {{< /button >}}
...
try (Viewer viewer = new Viewer("flowchart.vsdx")) {
...
![Render a Visio file to HTML](/viewer/java/images/rendering-basics/render-visio-documents/render-visio-to-html-embedded-resources.png)
...
![Place HTML resources in a separate folder](/viewer/java/images/rendering-basics/render-visio-documents/render-visio-to-html-external-resources.png)
...
![Render a Visio file to PDF](/viewer/java/images/rendering-basics/render-visio-documents/render-visio-to-pdf.png)
...
![Render a Visio file to PNG](/viewer/java/images/rendering-basics/render-visio-documents/render-visio-to-png-image.png)
...
The [VisioRenderingOptions.setFigureWidth](https://reference.groupdocs.com/viewer/java/com.groupdocs.viewer.options/visiorenderingoptions/#setFigureWidth-int-) method allows you to specify the shape width in pixels. The height is calculated automatically based on the aspect ratio of each shape.
...
![Render master shapes only](/viewer/java/images/rendering-basics/render-visio-documents/render-visio-shapes.png)
