...
try (Viewer viewer = new Viewer("resume.pdf")) {
    ...
    viewOptions.getPdfOptions.setRenderComments(true);
    viewer.view(viewOptions);
}
```
{{< /tab >}}
