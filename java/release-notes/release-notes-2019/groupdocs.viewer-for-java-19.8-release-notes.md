...
*   [Retrieving list of Outlook folders]({{< ref "viewer/java/rendering-basics/render-outlook-data-files.md" >}})
...
*   [Rendering messages from specified folder]({{< ref "viewer/java/rendering-basics/render-outlook-data-files.md" >}})
...
*   [Ignoring Empty Columns in Excel Worksheets When Rendering]({{< ref "viewer/java/rendering-basics/render-spreadsheets/specify-rendering-options.md" >}})
