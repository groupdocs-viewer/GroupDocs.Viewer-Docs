...
8.  [How to set default font name]({{< ref "viewer/java/developer-guide/rendering-documents/replace-missing-font.md" >}})
9.  [Show hidden pages for Visio files]({{< ref "viewer/java/developer-guide/rendering-documents/show-hidden-pages.md" >}})
...
14.  [Ability to set default font when rendering Diagram documents]({{< ref "viewer/java/developer-guide/rendering-documents/replace-missing-font.md" >}})
