...
* PDF documents - a flag that indicates whether document printing is allowed or not (see [Obtain information about a PDF file]({{< ref "/viewer/net/getting-started/viewer-use-cases/how-to-view-pdf-documents-using-csharp.md" >}}));
