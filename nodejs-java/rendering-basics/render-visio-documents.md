...
{{< tabs "render-visio-to-html-embedded">}}
{{< tab "JavaScript" >}}
```js
...
{{< tab "flowchart.vsdx" >}}
{{< tab-text >}}
`flowchart.vsdx` is the sample file used in this example. Click [here](/viewer/nodejs-java/_sample_files/rendering-basics/render-visio-documents/flowchart.vsdx) to download it.
{{< /tab-text >}}
{{< /tab >}}
{{< /tabs >}}
...
{{< tabs "render-visio-to-html-external">}}
{{< tab "JavaScript" >}}
```js
import { Viewer, HtmlViewOptions } from '@groupdocs/groupdocs.viewer';
